...
namespace PeliculasApi.Controllers
{
    ...
    public class PeliculaController : CustomBaseController
    {
        ...
        public PeliculaController(AppDbContext context, IMapper mapper, IAlmacenadorArchivos almacenadorArchivos, ILogger<PeliculaController> logger) : base(context, mapper)
        {
        ...
        public async Task<ActionResult<PeliculasIndexDTO>> Get()
        {
            ...
            resultado.Estrenos = mapper.Map<List<PeliculaDTO>>(proximosExtrenos);
        ...
        public async Task<ActionResult<List<PeliculaDTO>>> Filtrar([FromQuery] FiltroPeliculasDTO filtroPeliculasDTO )
        {
            ...
            await HttpContext.InsertarParametroPaginacion(peliculasQueryable,
