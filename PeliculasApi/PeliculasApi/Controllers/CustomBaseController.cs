...
namespace PeliculasApi.Controllers
{
    public class CustomBaseController : ControllerBase
    {
        ...
        protected async Task<List<TDTO>> Get<TEndidad, TDTO>(PaginacionDTO paginacionDTO) where TEndidad : class
        {
            var queryable = context.Set<TEndidad>().AsQueryable();
        ...
        protected async Task<List<TDTO>> Get<TEndidad, TDTO>(PaginacionDTO paginacionDTO, IQueryable<TEndidad> queryable) where TEndidad : class
        {
        ...
        protected async Task<ActionResult> Patch<TEndidad, TDTO>(int id, JsonPatchDocument<TDTO> patchDocument) where TDTO : class where TEndidad :class, IId
        {
            ...
            var entidadDB = await context.Set<TEndidad>().FirstOrDefaultAsync(x => x.Id == id);
