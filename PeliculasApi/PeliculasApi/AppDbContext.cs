...
namespace PeliculasApi
{
    public class AppDbContext : IdentityDbContext
    {
        ...
        {
            var rolAdminId = "4399ba12-329d-4337-ad32-65284e48709a";
            var usuarioAdminId = "f5a7ac3d-d12f-4b1c-847b-695ad91f75bf";
            ...
            var userName = "juanfdoa@hotmail.com";
            ...
            var usuarioAdmin = new IdentityUser()
            {
                ...
                PasswordHash = passwordHasher.HashPassword(null, "Aa123456789!")
            };
            ...
            */
            ...
            var jimCarrey = new Actor() { Id = 6, Nombre = "Jim Carrey", FechaNacimiento = new DateTime(1962, 01, 17) };
            var robertDowney = new Actor() { Id = 7, Nombre = "Robert Downey Jr.", FechaNacimiento = new DateTime(1965, 4, 4) };
            var chrisEvans = new Actor() { Id = 8, Nombre = "Chris Evans", FechaNacimiento = new DateTime(1981, 06, 13) };
